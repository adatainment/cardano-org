...
[cardano.org](https://cardano.org) follows an incremental evolution model. This repository avoids full rebuild projects, agency-led redesigns, or "start from scratch" initiatives unless there is a demonstrated, documented and reviewed technical need. Improvements should be made through small, reviewable, continuously shipped changes.
...
- [Suggest new features or improvements](https://github.com/cardano-foundation/cardano-org/discussions/categories/ideas) - have an idea for the website? Share it!
- [Report issues or bugs](https://github.com/cardano-foundation/cardano-org/issues/new) - found something broken? Let us know!
...
Whether you want to contribute to **cardano.org** (this site) or **[developers.cardano.org](https://developers.cardano.org)** (the developer portal), there are opportunities at every skill level. Both are open-source projects welcoming contributions!

**Contributing to developers.cardano.org?** Check out the [contribution guide](https://github.com/cardano-foundation/developer-portal).
...
- **[README](https://github.com/cardano-foundation/cardano-org/?tab=readme-ov-file)** - project overview and setup
- **[CONTRIBUTING.md](https://github.com/cardano-foundation/cardano-org/blob/staging/CONTRIBUTING.md)** - contribution guidelines
- **[CODE_OF_CONDUCT.md](https://github.com/cardano-foundation/cardano-org/blob/staging/CODE_OF_CONDUCT.md)** - community standards
...
- **New to GitHub?** Check out the [GitHub Hello World guide](https://guides.github.com/activities/hello-world/)
